	 ...
	 <div class="col-md-2">
        ...
        <div class="col-md-10">
            <div class="panel panel-primary">
                <div class="panel-heading">Admin > Projects</div>
						...
						@foreach($projects as $project)
						  <tr>
							...
							@foreach($clients as $clt)
								@if($clt->id == $project->client_id)
									<td>{{$clt->name}}</td>
								@endif
							@endforeach
							<td>{{$project->production}}</td>
							<td>{{$project->created_at}}</td>
							<td><a href="{{url('admin/projects/'.$project->id)}}"><i class="fa fa-eye" aria-hidden="true" style="font-size: 20px;" title="View Project"></i></a>&nbsp;&nbsp;&nbsp;<a href="{{url('admin/delprojects/'.$project->id)}}"><i class="fa fa-times-circle-o" aria-hidden="true" style="font-size: 20px;" title="Delete Project"></i></a></td>
						  </tr>
						@endforeach
						<?php }else {?>
							<tr>
