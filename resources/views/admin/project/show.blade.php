...
<div class="container">
	 ...
	 <div class="col-md-2">
        ...
        <div class="col-md-10">
            <div class="panel panel-primary">
                <div class="panel-heading"><i class="fa fa-bars"></i>Admin > Projects > {{$project->name}}</div>
	...
	<div class="row">
        <div class="col-xs-12 page-title-section">
            <h1 class="pull-left">{{ $project->name }} <a class="btn btn-success"  data-toggle="modal" data-target="#myModal" alt="Update"><i class="fa fa-pencil-square-o" aria-hidden="true" title="Update Project"></i></a></h1>
            <div class="clearfix"></div>
            <div class="col-sm-12 col-md-12 no-side-padding">
                <p><span style="color:black;font-size:18px;">Description:</span> <br>{{$project->description}}</p>
            </div>
            <div class="col-sm-12 col-md-6 no-side-padding pull-right">
				<a href="{{ $project->production }} " target="_blank" class="pull-right"><span class="label label-primary" style="font-size:14px;"><i class="ion-ios-world-outline"></i> Production</span></a>
				<a href="{{ $project->dev }}" target="_blank" class="pull-right"><span class="label label-warning" style="font-size:14px;"><i class="ion-ios-world-outline"></i> Development</span></a>
				<a href="{{ $project->github }}" target="_blank" class="pull-right"><span class="label label-success" style="font-size:14px;"><i class="ion-fork-repo"></i> Version Control</span></a>
            </div>
            <div class="clearfix"></div>
            <p>
                <hr>
